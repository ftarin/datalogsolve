...
typedef enum CAESAR_ENUM_IONATURE { CAESAR_INPUT_TUPLES, CAESAR_OUTPUT_TUPLES, CAESAR_OUTPUT } CAESAR_TYPE_IONATURE;

/*============================================================================*/
/* Common functionality */

extern CAESAR_TYPE_STRING CAESAR_COPY_STRING(CAESAR_TYPE_STRING CAESAR_STRING);
extern CAESAR_TYPE_NATURAL CAESAR_BITS_TO_ENCODE_ELEMENTS(CAESAR_TYPE_NATURAL NUMBER_OF_ELEMENTS);
