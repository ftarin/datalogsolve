...
CAESAR_TYPE_STRING CAESAR_COPY_STRING(CAESAR_TYPE_STRING CAESAR_STRING)
{
	...
	CAESAR_CREATE(CAESAR_STRING_COPY, strlen(CAESAR_STRING) + 1,
			CAESAR_TYPE_STRING);
...
CAESAR_TYPE_NATURAL CAESAR_BITS_TO_ENCODE_ELEMENTS(
		...
		CAESAR_TYPE_AREA_1 MARK)
{
	...
	fprintf(stdout, "[DBG] CREATION OF A TABLE NAMED %s:\n"
		"[DBG] \tBASE\n"
		"[DBG] \t\tAREA = @%x\n"
		"[DBG] \t\tALIGNMENT = %d\n"
		"[DBG] \t\tSIZE = %d\n"
		...
		"[DBG] \t\tAREA = @%x\n"
		"[DBG] \t\tALIGNMENT = %d\n"
		"[DBG] \t\tSIZE = %d \n", NAME, BASE, CAESAR_ALIGNMENT_AREA_1(BASE),
			CAESAR_SIZE_AREA_1(BASE), MARK, CAESAR_ALIGNMENT_AREA_1(MARK),
			CAESAR_SIZE_AREA_1(MARK) );
}
